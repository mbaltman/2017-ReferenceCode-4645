...
public class RobotMap 
{
	...
	public static final int steerFR = 9;
	public static final int steerFL = 10;
	public static final int steerBR = 11;
	public static final int steerBL = 12;
	
	public static final int driveFR = 7;
	public static final int driveFL = 13;
	public static final int driveBR = 14;
